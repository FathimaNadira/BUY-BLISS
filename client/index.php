		...
		<div class="row justify-content-between">
			<div class="col-lg-5">
				<div class="intro-excerpt">
					<h1>BUY BLISS.. Find Your Missing Piece</span></h1><br>
					<p class="mb-4">BUY BLISS Is The Best Place For Your Repair Needs BUY BLISS is an online platform
			...
			<div class="col-lg-7">
				<div class="hero-img-wrap">
					<img src="../images/front1.png" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
