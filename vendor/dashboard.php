                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <br>
                                <span class="h2 font-weight-bold mb-0">RS.<?php echo $totalShippedAmount; ?></span>
                            </div>
                            <div class="col-auto">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <br>
                                <span class="h2 font-weight-bold mb-0">RS.<?php echo getVendorBalance($vendorName, $conn); ?></span>
                            </div>
                            <div class="col-auto">
            ...
            <div class="col-xl-3 col-lg-6 mb-3 mb-xl-0">
                <div class="card card-stats">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <h5 class="card-title text-uppercase text-muted mb-0">Customer Orders</h5>
                                <br>
